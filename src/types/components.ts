...
import type { ComponentPrototypeSpec, ResponsiveOverride } from './project';
...
export interface ComponentNode {
  ...
  // Syndrid Studio extensions (all optional for backwards-compatible .tui v1 files)
  responsive?: Record<string, ResponsiveOverride>;
  prototype?: ComponentPrototypeSpec;
