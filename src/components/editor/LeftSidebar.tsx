...
import { Package, Layers, AlertTriangle, Boxes } from 'lucide-react';
...
type Tab = 'components' | 'layers' | 'system';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex border-b border-border">
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1 px-2 py-3 text-sm font-medium transition-colors ${
            activeTab === 'system'
              ? 'bg-background border-b-2 border-primary text-foreground'
              : 'text-muted-foreground hover:text-foreground hover:bg-accent'
          }`}
          title="Syndrid design system"
        >
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        ...
        {activeTab === 'system' && <DesignSystemPanel />}
      </div>
